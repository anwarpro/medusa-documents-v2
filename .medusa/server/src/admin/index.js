  ...
  React.useEffect(() => {
    ...
    fetch(`/admin/documents/invoice`, {
      ...
      if (responseJson && responseJson.buffer) {
        ...
        ui.toast.dismiss();
        ui.toast.error("Invoice", {
          description: (responseJson == null ? void 0 : responseJson.message) || "Problem happened when generating invoice"
        });
      }
      setLoading(false);
    }).catch((error2) => {
      var _a, _b;
      console.error("Invoice generation error:", error2);
      setLoading(false);
      ui.toast.dismiss();
      const errorMessage = (error2 == null ? void 0 : error2.message) || ((_b = (_a = error2 == null ? void 0 : error2.response) == null ? void 0 : _a.data) == null ? void 0 : _b.message) || "An unexpected error occurred while generating the invoice";
      ui.toast.error("Invoice", {
...
const OrderTable$1 = ({ setContextFilters, searchTerm = "" }) => {
    ...
    fetch(url, {
      ...
      if (searchTerm && searchTerm.trim() && Array.isArray(result.orders)) {
        ...
        const filteredOrders = result.orders.filter(
          (order) => {
            var _a;
            return (_a = order.display_id) == null ? void 0 : _a.toString().toLowerCase().includes(searchLower);
          }
        );
        filteredResult = {
          ...result,
...
const OrdersTab = ({ searchTerm = "" }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(material.Grid, { container: true, spacing: 2, children: /* @__PURE__ */ jsxRuntime.jsx(material.Grid, { item: true, xs: 12, md: 12, xl: 12, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Container, { children: /* @__PURE__ */ jsxRuntime.jsx(OrderTable, { setContextFilters, searchTerm }) }) }) });
};
...
const DocumentsPage = () => {
  ...
  const hidePro = typeof __vite_import_meta_env__ !== "undefined" && // @ts-expect-error - import.meta is available in Vite's ESM build output
  (__vite_import_meta_env__ == null ? void 0 : __vite_import_meta_env__.VITE_MEDUSA_ADMIN_MEDUSA_DOCUMENTS_HIDE_PRO);
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Tabs, { defaultValue: "orders", children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(material.Box, { sx: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 2, gap: 2 }, children: [
      /* @__PURE__ */ jsxRuntime.jsxs(ui.Tabs.List, { style: { flex: 1 }, children: [
        ...
        !hidePro && /* @__PURE__ */ jsxRuntime.jsx(ui.Tabs.Trigger, { value: "pro", style: { color: "purple" }, children: "Pro version" })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsxs(material.Box, { sx: { display: "flex", alignItems: "center", gap: 1, minWidth: "300px" }, children: [
        /* @__PURE__ */ jsxRuntime.jsx(icons.MagnifyingGlass, { className: "text-ui-fg-muted", style: { width: "16px", height: "16px" } }),
        /* @__PURE__ */ jsxRuntime.jsx(
          ui.Input,
          {
            type: "text",
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Tabs.Content, { value: "orders", children: [
      /* @__PURE__ */ jsxRuntime.jsx(material.Box, { height: 20 }),
      /* @__PURE__ */ jsxRuntime.jsx(OrdersTab, { searchTerm: orderSearch })
    ] }),
    ...
    !hidePro && /* @__PURE__ */ jsxRuntime.jsxs(ui.Tabs.Content, { value: "pro", children: [
      /* @__PURE__ */ jsxRuntime.jsx(material.Box, { height: 20 }),
