...
import { FlyingBox, EllipsisHorizontal, InformationCircle, DocumentText, MagnifyingGlass } from "@medusajs/icons";
...
const OrdersTab = ({ searchTerm = "" }) => {
  ...
  return /* @__PURE__ */ jsx(Grid, { container: true, spacing: 2, children: /* @__PURE__ */ jsx(Grid, { item: true, xs: 12, md: 12, xl: 12, children: /* @__PURE__ */ jsx(Container, { children: /* @__PURE__ */ jsx(OrderTable$1, { setContextFilters, searchTerm }) }) }) });
};
...
const DocumentsPage = () => {
  ...
  return /* @__PURE__ */ jsxs(Tabs, { defaultValue: "orders", children: [
    ...
    /* @__PURE__ */ jsxs(Box, { sx: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 2, gap: 2 }, children: [
      /* @__PURE__ */ jsxs(Tabs.List, { style: { flex: 1 }, children: [
        ...
        !hidePro && /* @__PURE__ */ jsx(Tabs.Trigger, { value: "pro", style: { color: "purple" }, children: "Pro version" })
      ] }),
      /* @__PURE__ */ jsxs(Box, { sx: { display: "flex", alignItems: "center", gap: 1, minWidth: "300px" }, children: [
        /* @__PURE__ */ jsx(MagnifyingGlass, { className: "text-ui-fg-muted", style: { width: "16px", height: "16px" } }),
        /* @__PURE__ */ jsx(
          Input,
          {
            type: "text",
    ...
    /* @__PURE__ */ jsxs(Tabs.Content, { value: "orders", children: [
      /* @__PURE__ */ jsx(Box, { height: 20 }),
      /* @__PURE__ */ jsx(OrdersTab, { searchTerm: orderSearch })
    ] }),
    ...
    !hidePro && /* @__PURE__ */ jsxs(Tabs.Content, { value: "pro", children: [
      /* @__PURE__ */ jsx(Box, { height: 20 }),
      /* @__PURE__ */ jsx(ProTab, {})
    ] })
  ] });
